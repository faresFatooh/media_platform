...
export const FilmIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0-2.25l2.25 1.313M12 12.75l-2.25 1.313M3 16.5l2.25-1.313M3 16.5l2.25 1.313M3 16.5V19.5m9-3l2.25-1.313M12 16.5l-2.25-1.313M12 16.5V19.5m0-3l2.25 1.313m0-12.75l-2.25-1.313M21 16.5l-2.25-1.313M21 16.5l-2.25 1.313M21 16.5V19.5m-18-3l2.25 1.313m-2.25-1.313l2.25-1.313m0 0l2.25 1.313m2.25-1.313l2.25 1.313m0 0l2.25 1.313m2.25-1.313l2.25 1.313M5.25 6.438l2.25 1.312m0 0l2.25 1.313m2.25-1.313l2.25 1.313m2.25-1.313l2.25 1.313M5.25 19.5l2.25-1.313m0 0l2.25-1.313m2.25 1.313l2.25-1.313m2.25 1.313l2.25-1.313m-18 0v-2.25" />
    </svg>
);

export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311l.738-1.137a6.01 6.01 0 00-3.75-5.455m0 0a6.01 6.01 0 013.75 5.455m-3.75-5.455a6.01 6.01 0 00-3.75 5.455m0 0l-.738 1.137m3.75-1.137a12.06 12.06 0 00-4.5 0" />
    </svg>
);
