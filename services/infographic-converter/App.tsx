...
import { SlideViewer, exportSlideAsImage } from './components/SlideViewer';
...
const App: React.FC = () => {
  ...
  slideRefs.current = slides.map((_, i) => slideRefs.current[i] ?? React.createRef<HTMLDivElement>());
            ...
            {isLoading && (
              <div className="mt-12 text-center">
                <div className="inline-flex items-center justify-center gap-4">
                  ...
                  <span className="text-2xl font-semibold text-gray-700">جاري التحليل والإنشاء...</span>
                </div>
              </div>
            )}
