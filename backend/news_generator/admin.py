...
# This code tells the Django admin: "Please show these models on the admin page."
# The ModelAdmin classes also add powerful features like search, filtering, and a better list view.
